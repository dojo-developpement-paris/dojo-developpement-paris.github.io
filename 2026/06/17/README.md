Prochaine session : le 26/06 à Shodo
...
## Retro
- TDD - Forth or Haskell Bowling Score TCRDD
    - c'est comme avec des agents IA (mal de tête à cause du context switching)
    - la pièce d'Ubald a fait beaucoup de face 
    - intéressant de se replonger dans Forth (83 for the win)
...
## Sujets
- 7 - B - Demo TDD Bowling Score en Prolog 
- 7 - E - Mob Python - Word Ladder : cat dog -> cat cot cog dog 
- 6 - F - Mob Prolog - Word Ladder : cat dog -> cat cot cog dog
- 5 - C - Mob TDD Bowling Score en Prolog
- 4 - A - Python, Mob bras robotique en 3D -  
- 2 - D - Mob Python Générateur de Haiku
- 6 - G - Mob Python - Wordle 
