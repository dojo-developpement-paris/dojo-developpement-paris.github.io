Prochaine session : le 17/06 à CodeWorks
...
## Retro
- TDD - Haskell - Ballade dans les functors, applicatives, monad et monad transformers
  - 
...
## Sujets
- 0 - A - Mob, TCRDD Rust Refacto d'une code base existante (gitgamble)
- 0 - B - Demo TDD Bowling Score en Prolog 
- 0 - C - Mob TDD Bowling Score en Prolog
- 0 - D - Mob TCRDD Forth / Haskell Bowling Score 
