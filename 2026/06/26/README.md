...
## Retro
- Demo TDD Bowling Score en Prolog
  - Prolog est assez exotique
  - TDD aussi
  - découvrir TDD a permis de réduire la boucle de feedback
    - c'est ludique et pratique
    - et ça permet de mieux comprendre le code
...
## Sujets
- 4 - A - Mob - TDD - Python - Bowling score
- 2 - B - Mob - TDD - Python - wordle
- 8 - C - Mob strong style tournant - TDD - Scala - maitre D' Mark Seeman (gérer des réservations dans un restau)
- 5 - D - Fishbowl - TCRDD - Rust - à qui s'est le tour d'un tic tac toe ?
