Prochaine session : le 13/03/2026 à Shodo
...
## Retro
- mob - TCRDD - haskell - kata poker hand déterminer les 5 meilleurs cartes parmis 7
  - Beaucoup du coup chaotique nombreux
  - Sujet large direction tardive
  - Difficile d'apprendre Haskell et traiter le sujet du poker em même temps
  - Orientation a permi de définir les régles et direction, faire apparaitre des étapes claires
...
## Sujets
- 2 - A - TDD - Rust - Kata score de bowling - 
- 0 - B - TDD - Rust - Bank kata - Double loop
- 0 -  -  -  -  - 
