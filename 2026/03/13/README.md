Prochaine session : le 2026-03-17 à Arolla
...
## Retro
- TDD - Rust - Kata score de bowling - 
  - personne n'était là
...
## Sujets
- 1 - A - mob - TCRDD - TypeScript - forest fire model : test -> CLI
- 4 - B - mob - TCRDD - Rust - forest fire model : test -> CLI
- 8 - C - demo - TDD - haskell - mastermind, l'ordi devines le code en 5 coups ou moins : Knuth minmax
- 2 - D - mob - TCRDD - typescript - kata bank account focus sur l'event sourcing, le compte bancaire ne peut pas etre négatif
