Prochaine session : le 2026-03-24 à Arolla
...
## Retro
- demo - TDD - haskell - mastermind, l'ordi devines le code en 5 coups ou moins : Knuth minmax
  - on n'a pas fini, il faudrait le double du temps
    - en environ 1h, on avait fait l'algo qui permet de déterminer si une combinaison est bonne ou pas
  - l'algo minmax est difficile à comprendre
  - les pas étaient très grands
...
## Sujets
- 0 - A - mob - TDD - TypeScript - graph de crêpes pour trouver le meilleur tri de crêpes
- 0 - B - demo - TDDish - Haskell - trouver le code secret d'un mastermind en moins de 5 coups en reprennant la partie matching
- 0 - C - demo - TDDish - Rust - trouver le code secret d'un mastermind en moins de 5 coups
- 0 - D - mob - TDD - Haskell - algo de memory
- 0 - E - mob - TCRDD - Python - balanced parenthesis, avec commentaire #
