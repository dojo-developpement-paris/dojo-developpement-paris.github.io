...
## Retro
- demo - TDDish - Haskell - trouver le code secret d'un mastermind en moins de 5 coups en reprennant la partie matching
  - Ce n'est pas fini
  - On a poursuivi la démo précédente
  - On avancé sur l'algo et sur la découverte de Haskell
  - C'est bien de faire plusieurs fois différemment
