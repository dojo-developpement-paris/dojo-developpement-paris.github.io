Prochaine session : le 2026-05-27 à Proxym
...
## Retro
- mob strong style tournant - TCRDD - Rust - Chaines de markov outside in
  - on a fait installer Nix sur la machine d'Ubald
  - on n'a pas fait de mob strong style tournant, juste du mob
  - on ne sait pas trompé dans les paris
  - Ubald a été driver sur du Rust
  - Ubald a animé
  - Rust est relou avec `str` et `String`
  - le design commençait à émerger
...
## Sujets
- 24 - A - demo interactive - REPL - haskell - balade autour des functors, functors applicatif, monads
- 8 - B - mob strong style tournant - TCRDD - Rust - Chaines de markov outside in - la suite de la dernière fois
- 3 - C - mob strong style tournant - TCRDD - Bash - Chaines de markov outside in
- 6 - D - mob strong style tournant - TCRDD - Nix - Chaines de markov outside in
- 4 - E - mob -  - Rust - péter git-gamble
- 7 - F - mob - TCRDD - Rust - refactorer git-gamble
- 15 - G - demo - TDD - haskell - continuer 2025 jour 10 advent of code
- 13 - H - mob strong style tournant - TDD - Rust - maze solver
