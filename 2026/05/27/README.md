Prochaine session : le 2026-06-02 à Arolla
...
## Retro
- demo interactive - REPL - haskell - balade autour des functors, functors applicatif, monads
  - on avait l'impression d'avoir tout compris et puis une semaine plus tard
  - c'était très théorique
  - c'était intéressant
    - voir les différences avec d'autres langages plus conventionnels
...
## Sujets
- 6 - A - Mob - TCRDD - Rust - algo d'ascenseur ; avec une queue d'étage, optimiser le temps d'attente ; toutes les demandes arrivent en meme temps
- 1 - B - Mob - TCRDD - Rust - refactorer une codebase en Rust
- 0 - C - Mob - TCRDD - Shell - découper en CHANGELOG en plusieurs fichiers et générer le menu
