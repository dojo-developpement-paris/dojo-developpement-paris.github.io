Prochaine session : le 22/05/2026 à Shodo
...
## Retro
- demo - TCRDD - Haskell - Advent of Code 2025 jour 10 parti 1
  - demo interactive avec beaucoup de questions sur haskell
  - on a pas fait de TCRDD, on a juste fait du TDD, on a juste collectivement oublié
  - on a fait évoluer l'implementation: au début les lampes étaient juste un nombre puis on a changé en liste de booléen
  - on a complexifié l'implementation petit à petit
...
## Sujets
- 2 - A - mob strong style tournant - TCRDD - Rust - Chaines de markov outside in
- 1 - B - mob - TDD - Vuejs - Fire forest model
- 1 - C - randori - TCRDD - Typescript - Morpion - determiner l'état d'une grille
