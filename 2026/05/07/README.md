Prochaine session : le 15/05/2026 à Shodo
...
## Retro
- mob strong style tournant - TCRDD - Rust - fire forest model : implémenter les règles ; TUI si on a le temps
  - Les cycles étaient un peu courts
  - On est pas allé très loin
  - On a changé de plan: on commence par coder et on se pose les questions après
...
## Sujets
- 4 - A - mob - TDD - Python - roman numeral kata : nombres arabes -> nombres romains
- 5 - B - mob - TDD - Vuejs - Fire forest model
- 5 - C - mob - TCRDD - Haskell - Advent of Code 2025 jour 10 parti 1
- 7 - D - demo - TCRDD - Haskell - Advent of Code 2025 jour 10 parti 1
