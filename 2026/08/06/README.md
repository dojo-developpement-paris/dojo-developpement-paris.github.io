...
## Retro
- demo - Lisp / Haskell / Rust - closure : transmettre une fonction à executer plus tard avec son environnement
  - super intéressant
  - la définition de closure était ambigue, c'était un cas spécial avec aucun argument "fermé" qui récupérer un bout du scope parent
...
## Sujets
- 11 - Mob - TCRDD - Rust - sudoku checker : grid -> is valid ?
- 6 - Mob - TCRDD - TypeScript - sudoku checker : grid -> is valid ?
- 4 - rotating mob strong style - TCRDD - Rust - sudoku checker : grid -> is valid ?
- 1 - rotating mob strong style - TCRDD - TypeScript - sudoku checker : grid -> is valid ?
- 5 - mob - TCRDD - TypeScript - mars rover kata
