...
## Retro
- Mob - TCRDD - Rust - sudoku checker : grid -> is valid ?
  - la façon dont on s'y est pris était assez exemplaire par rapport à TDD
    - à la fin, on avait un algo presque optimal
  - dubitatif de parler anglais quand quelqu'un n'est pas francophone, ça pourrait créer un sentiment d'exclusion pour les non anglophones
  - Rust est intéressant à apprendre
  - il y avait beaucoup d'interruption de discussion, c'était difficile à suivre
  - grille de sudoku semble bien adapté en timing
...
## Sujets
- 2 - mob strong style tournant - TCRDD - JS - kata tennis ; compter les points d'un jeu
- 8 - demo - lean coffee - outil de vote
- 5 - Fishbowl - TCRDD - Rust - kata touché coulé
- 9 - mob - TDD - Rust - kata RPN calculator 5 5 + 2 * = 20
