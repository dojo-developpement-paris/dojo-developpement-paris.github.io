Prochaine session : le 2026-03-02 à Arolla
...
## Retro
- TypeScript - Mob - Le tri de crêpe
  - sans utiliser aucune fonction natif JS
  - en découpant en plus petites fonctions, les fonctions auraient été plus simples et on aurait été plus loin
  - c'était intéressant de faire en JS natif, ça permettait de voir comment utiliser le destructuring pour faire une sorte de pattern matching, pour montrer comment fonctionne le spread operator
...
## Sujets
- 9 - A - mob - TCRDD - rust - arbitre d'un mastermind
- 4 - B - mob - 20min un groupe décide alternativement - rust - anticiper une valeur d'une valeur à la hausse ou à la baisse d'une API de trading
- 4 - C - mob - TCRDD - python - kata poker hand déterminer les mains parmis 5 cartes
- 10 - D - mob - TCRDD - haskell - kata poker hand déterminer les 5 meilleurs cartes parmis 7
- 5 - E - mob - TCRDD - typescript - kata bank account focus sur l'event sourcing, le compte bancaire ne peut pas etre négatif
