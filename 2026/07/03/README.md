Prochaine session : le 08/07/2026 à Octo
...
## Retro
- Mob strong style tournant - TDD - Scala - maitre D' Mark Seeman (gérer des réservations dans un restau)
  - Problème de setup
  - On est pas allé très loin
  - Syntaxe de scala est atypique
  - Le sujet est un peu long pour un dojo
  - Pour aller plus loin dans le kata, on aurait du prendre un langage mieux maitrisé par l'audience
  - Mob strong style tournant est un bon moyen de faire participer tout le monde
...
## Sujets
- 8 - A - Mob strong style - TDD - Typescript - Tennis kata (implementer le compte du score)
- 9 - B - Demo interactive - TCRDD - Vuejs - Fireforest model
- 3 - C - Fishbowl - TCRDD - Python - Main de poker
- 2 - D - Fishbowl - TDD - Python - Pendu
- 2 - E - Mob strong style - TDD - Python - Pendu
