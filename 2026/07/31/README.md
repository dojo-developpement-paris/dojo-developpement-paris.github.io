Prochaine session : le 2026-08-06 à Proxym
...
## Retro
- mob - TCRDD - Rust - Roman Numeral 14 => XIV - conception avec un table de correspondance
  - il y avait un plan partiel qui nous menait vers un design clair pour le finir
  - les `trait` Rust semble etre une contrainte mais sont plutot un boost
  - on était peu nombreux et ça a bien marché, c'était fluide
...
## Sujets
- 4 - demo - lean coffee - outil de vote
- 9 - demo - Lisp / Haskell / Rust - closure : transmettre une fonction à executer plus tard avec son environnement
- 4 - mob strong style tournant - TCRDD - java - kata de refactoring tell don't ask
- 7 - Fishbowl - TCRDD - Rust - kata touché coulé
