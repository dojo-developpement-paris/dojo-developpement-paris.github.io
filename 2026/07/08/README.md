...
## Retro
- Demo interactive - TCRDD - Vuejs - Fireforest model
  - appliquer TDD semblait difficile
  - ce qui a été fait : afficher une foret de 9 cases statiques
  - bien aimé la démarche la TDD avec un aspect visuel
    - on voyait bien la progression
  - préparer la mise à jour de l'état aurait permit d'avoir la vue interactive à la fin
  - créer un projet depuis 0 aurait permi de montrer que le setup n'est pas compliqué à faire
...
## Sujets
- 13 - demo - présentation - Haskell / Common Lisp / C / Forth - kata bowling score avec 4 langages avec différents paradigmes
- 1 - Demo interactive - TCRDD - Vuejs - continuer le sujet de la dernière fois : Fireforest model ; faire la fonction de mise à jour du modèle
- 10 - mob - TCRDD - Rust - vérifier un mastermind
- 0 - mob - TCRDD - Clojure - kata tennis
