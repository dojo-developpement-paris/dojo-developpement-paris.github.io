...
## Retro
- demo - présentation - Haskell / Common Lisp / C / Forth - kata bowling score avec 4 langages avec différents paradigmes
  - beaucoup aimé la partie Haskell
  - la partie Forth était hardcore, surtout pour finir
  - Common Lisp a plein de parenthèses, c'est difficile à lire pour commencer
  - parfait pour voir des paradigmes opposés sur le meme problème
  - 4 façons de résoudre sur 4 langages différents
  - les tests unitaires étaient les memes
    - ils étaient suffisament simples pour etre compris d'un langage à l'autre
  - démo multi-languages à refaire
...
## Sujets
- 10 - 0 - mob - TDD - haskell / rust - pile / face pour changer de langage - conversion de nombres en nombre romain : 13 => XIII
- 4 - 0 - demo - lean coffee - outil de vote
- 4 - 0 - mob - TCRDD - TypeScript / Vitest - kata mars rover
- 9 - 0 - mob strong style tournant - TCRDD - Ruby - kata de refactoring : Tell Don't Ask
