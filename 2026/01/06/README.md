Prochaine session : le 2026-01-16 à Shodo
...
## Retro
- mob - Demo - rust - reprendre turtle
  - voir un exemple de GTK avec Rust
  - revoir les tortues
  - perdue à la fin
...
## Sujets
- 8 - A - mob - TypeScript - TCRDD - jeu de memory
- 5 - B - fishbowl - typescript - TCRDD - règles d'un mastermind
- 3 - C - mob - TypeScript - TDD - mots proches ; bar [barre arbre] => [barre arbre] ; balle [arbre barre] => [barre arbre]
- 2 - D - mob - Python - TDD - matching de lignes
- 7 - E - mob - typescript - TCRDD - règles d'un mastermind
