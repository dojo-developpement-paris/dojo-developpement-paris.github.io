Prochaine session : le 2026-01-23 à Shodo
...
## Retro
- mob - TypeScript - TCRDD - jeu de memory
  - on a passé beaucoup de temps à cadrer le sujet, ce n'était pas clair dès le début
  - il faisait trop froid
  - on a passé beaucoup de temps à tester des cas limites plutot que des cas métier
...
## Sujets
- 11 - A - mob - TDD - haskell - jeu de memory
- 9 - B - mob - TCRDD - TypeScript - Mars Rover
- 7 - C - fishbowl - TCRDD si on peut - Rust - `mask` monter de version de dépendance
- 6 - D - fishbowl - TCRDD - typescript - 8 queens
- 15 - E - fishbowl - TCRDD - Haskell - 8 queens
- 12 - F - fishbowl - TCRDD - prolog - 8 queens
