Prochaine session : le 2026-01-27 à Arolla ou 2026-01-30 à Shodo
...
## Retro
- fishbowl - TCRDD - Haskell - 8 queens
  - c'était bien on a fait du sport
  - on a commencé en outside-in puis on a fait en inside-out
    - on a testé des détails d'implems plutot qu'un comportement métier
    - et on savait pas trop où on allait +1
  - on n'a pas défini quel était l'objectif du kata et ça nous a posé un problème +1
  - on réussi a avoir du turn over en fishbowl
  - ToF a facilité le groupe et ça a facilité le travail
  - on galère à commencer le kata (comme d'hab')
  - il faudrait trouver comment formuler dans les règles pour mieux cadrer le kata pour savoir vers où on va et etre moins perdu
  - le fishbowl est assez intimidant, il faut arriver à aller au milieu et prendre le lead
    - le role de navigator n'était pas toujours rempli
      - ce qui fait un moment de gêne
...
## Sujets
- 2 - A - fishbowl - TCRDD si on peut - Rust - `mask` monter de version de dépendance
- 2 - B - fishbowl - TCRDD - TypeScript - mars rover ; en commençant une liste de commande => on sait où il se trouve
- 9 - C - fishbowl - TCRDD - Rust - mars rover ; en commençant une liste de commande => on sait où il se trouve
- 8 - D - fishbowl - TCRDD - en double loop TDD - TypeScript - mars rover ; en commençant une liste de commande => on sait où il se trouve
