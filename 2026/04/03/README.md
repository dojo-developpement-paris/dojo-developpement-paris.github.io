Prochaine session : le  07/04/2026 à Arolla
...
## Retro
- Mob - TDD - Haskell - Bank kata <https://www.codurance.com/katas/bank>
    - cool de voir les outils de typages (Mock)
    - dans tout autre langage, mock = black magic, ici, il faut juste les bons types
    - chatgpt super utile, mais on a fait en pas à pas
    - Patrick était content d'apprendre des trucs et de redécouvrir 
...
## Sujets
- 7 - A - fishbowl - TCRDD  - rust - puissance 4, le statut : à qui de jouer, ou qui est le gagnant ou ex-aequo
- 3 - B - fishbowl - TCRDD  - haskell - puissance 4 idem
- 3 - C - demo - mastermind le solveur devine en 5 coups le code secret
- 4 - D - mob - TCRDD - haskell - le jeu de la vie
- 8 - E - fishbowl - no test - rust - puissance 4 le statut
