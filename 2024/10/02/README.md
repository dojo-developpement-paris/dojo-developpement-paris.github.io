...
Retro :
- mob - rust - tcrdd - recherche de nombre premiers
  - approche trial / trial optimisé facteurs premiers + tests de performance
  - initialisation de tableau
  - les profils de performance du laptop ont un impact
...
Sujets :
- 0 - A - Mob C, Addition de grands nombres
- 0 - B - Nombres premiers en Forth 
