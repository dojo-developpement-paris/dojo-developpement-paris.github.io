...
- mob - Common Lisp - Tour d'Hanoi
  - we did it in inside out (for pin)
  - Marc & ToF say we did outside in
  - we had progressed a lot but not finished
...
- 2 - A - mob - java - mars rover
- 2 - B - mob - typescript - tcrdd kata bowling
- 9 - C - mob - rust - tcrdd - Hanoi towers
- 5 - D - mob - python - tcrdd - to decimal number -> roman numeral : 10 -> X
