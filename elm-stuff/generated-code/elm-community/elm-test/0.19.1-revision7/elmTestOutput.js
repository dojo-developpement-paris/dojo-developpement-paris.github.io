...
var $author$project$Dummy$myTest = function (_v0) {
	return A2($elm_explorations$test$Expect$equal, 'left', 'left');
};
var $author$project$Main$object = function (m) {
	return {mass: m};
};
var $elm$core$Basics$round = _Basics_round;
var $elm$core$Basics$sqrt = _Basics_sqrt;
var $elm$core$Basics$toFloat = _Basics_toFloat;
var $author$project$Main$radius = function (o) {
	return $elm$core$Basics$round(
		$elm$core$Basics$sqrt(o.mass));
};
...
var $author$project$Dummy$dummy = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					A2($elm_explorations$test$Test$test, 'This test will show the existence of a test harness', $author$project$Dummy$myTest)
				])),
			A2(
			$elm_explorations$test$Test$describe,
			'an object',
			_List_fromArray(
				[
					...
					'its mass should influence its radius',
					function (_v0) {
						return A2(
							$elm_explorations$test$Expect$equal,
							4,
							$author$project$Main$radius(
								$author$project$Main$object(16)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'its mass should influence its radius for any mass',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							5,
							$author$project$Main$radius(
								$author$project$Main$object(25)));
					})
				]))
		]));
