...
- demo - rust - TDD visuel - faire avancer une tortue graphique

  - Monter affichage Gtk 4 et TDD
  - On a vu les affichages
  - Kata ambitieux
  - Bootstrap demander à chatGPT fonctionne mais doit être retravailler
...
- 0 - A - mob - TDD - rust - bowling score - test des recettes avant de se lancer
* - 2 - B - mob - Demo - rust - reprendre turtle
- 0 - C - mob - TDD - typescript - mastermind
- 0 - D - mob - TDD - python - numeral to roman
