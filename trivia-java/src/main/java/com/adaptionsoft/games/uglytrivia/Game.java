...
public class Game {
	...
	public boolean add(String playerName) {
	    ...
	    display.display("They are player number " + players.size());
		return true;
	}
	...
	public void roll(int roll) {
		display.display(players.get(currentPlayer) + " is the current player");
		...
		if (inPenaltyBox[currentPlayer]) {
			if (roll % 2 != 0) {
				...
				display.display(players.get(currentPlayer) + " is getting out of the penalty box");
				places[currentPlayer] = places[currentPlayer] + roll;
				if (places[currentPlayer] > 11) places[currentPlayer] = places[currentPlayer] - 12;
				
				display.display(players.get(currentPlayer)
						+ "'s new location is " 
						+ places[currentPlayer]);
				display.display("The category is " + currentCategory());
				askQuestion();
			} else {
				display.display(players.get(currentPlayer) + " is not getting out of the penalty box");
	...
	public boolean wrongAnswer(){
		...
		display.display(players.get(currentPlayer)+ " was sent to the penalty box");
