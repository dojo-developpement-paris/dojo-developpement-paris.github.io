...
Elm.Baobab.make = function (_elm) {
   ...
   var triangleSansBase = F3(function (_v0,
   t,
   a) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
            return function () {
                 var yS = _v0._1 + t * $Basics.cos(a) * $Basics.sin(a);
                 var xS = _v0._0 + t * $Basics.cos(a) * $Basics.cos(a);
                 return _L.fromArray([{ctor: "_Tuple2"
                                      ,_0: _v0._0 + t
                                      ,_1: _v0._1}
                                     ,{ctor: "_Tuple2",_0: xS,_1: yS}
                                     ,{ctor: "_Tuple2"
                                      ,_0: _v0._0
                                      ,_1: _v0._1}]);
              }();}
   ...
   var carreSansBase = F2(function (_v4,
   t) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return _L.fromArray([{ctor: "_Tuple2"
                                ...
                                ,{ctor: "_Tuple2"
                                 ...
                                 ,_1: _v4._1}]);}
         _U.badCase($moduleName,
         "on line 44, column 25 to 61");
      }();
   });
   var maisonSansBase = F3(function (_v8,
   t,
   a) {
      return function () {
         switch (_v8.ctor)
         {case "_Tuple2":
            return function () {
                 var triangle = A3(triangleSansBase,
                 {ctor: "_Tuple2"
                 ,_0: _v8._0
                 ,_1: _v8._1 + t},
                 t,
                 a);
                 var carre = A2(carreSansBase,
                 {ctor: "_Tuple2"
                 ,_0: _v8._0
                 ,_1: _v8._1},
                 t);
                 return _L.fromArray([carre
                                     ,triangle]);
              }();}
         _U.badCase($moduleName,
   ...
   var rotations = F3(function (_v12,
   a,
   p) {
      return function () {
         switch (_v12.ctor)
   ...
   var baobab45 = F3(function (niveau,
   _v24,
   t) {
      return function () {
         switch (_v24.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 {case 0:
                    return _L.fromArray([]);}
                 return function () {
                    var angle = $Basics.degrees(35);
                    var maison = A3(maisonSansBase,
                    {ctor: "_Tuple2"
                    ,_0: _v24._0
                    ,_1: _v24._1},
                    t,
                    angle);
                    var xS = _v24._0 + t * $Basics.cos(angle) * $Basics.cos(angle);
                    var yS = t + _v24._1 + t * $Basics.cos(angle) * $Basics.sin(angle);
                    var sommet = {ctor: "_Tuple2"
                                 ,_0: xS
                                 ,_1: yS};
                    var gauche = $List.map(A2(rotations,
                    {ctor: "_Tuple2"
                    ,_0: _v24._0
                    ,_1: _v24._1 + t},
                    angle))(A3(baobab45,
                    ...
                    ,_1: _v24._1 + t},
                    t * $Basics.cos(angle)));
                    var droite = $List.map(A2(rotations,
                    sommet,
                    angle - $Basics.degrees(90)))(A3(baobab45,
                    niveau - 1,
                    sommet,
                    t * $Basics.sin(angle)));
   ...
   _elm.Baobab.values = {_op: _op
                        ,baobab45: baobab45
                        ,rotations: rotations
                        ,maisonSansBase: maisonSansBase
                        ,carreSansBase: carreSansBase
                        ,triangleSansBase: triangleSansBase};
   return _elm.Baobab.values;
};
...
Elm.Main.make = function (_elm) {
   ...
   1000,
   1000)($List.map($Graphics$Collage.traced($Graphics$Collage.solid($Color.green)))(A3($Baobab.baobab45,
   10,
